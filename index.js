...
const config = {
    A187: '🔰_MyBot_🔰',
    instagram: 'https://instagram.com/_ahhmad_.f',
    nomer: 'wa.me/6281386008628',
    aktif: 'TERGANTUNG OWNER',
    youtube: 'https://www.youtube.com/channel/UC0ECqULbTSD0Wiz8mz0wTVw',
...
client.on('qr', qr => {
   ...
   console.log(`[ ${time} ] QR code by AhmadGans & MYBOT, Scan kode qr mu cok!`)
})
   ...
   case 'bitly':
    ...
    case 'bucin':
     ...
     case 'cooltext':
           ...
           break
          case 'creator':
            client.sendContact(from, '6281386008628@c.us')
            break
      case 'tts':
